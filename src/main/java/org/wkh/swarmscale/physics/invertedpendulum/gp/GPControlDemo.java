...
public class GPControlDemo {
    ...
    public static void main(String[] args) {
        ...
        final GPForceController controller = system -> {
            ...
            double force = Math.sin((Math.sin(Math.sin(poleVelocity)) / (((Math.cos(4) * Math.sin((Math.sin((Math.sin(Math.cos(poleRotation) / cartVelocity) - ((poleRotation / Math.cos(4)) / (poleVelocity / cartVelocity))) + Math.cos(poleRotation)) - ((Math.sin(Math.cos(poleRotation) / cartVelocity) / (poleVelocity / cartVelocity)) / (poleVelocity / cartVelocity))) + Math.sin(Math.PI))) * ((Math.PI * 10) * Math.sin(Math.cos(poleRotation) / cartVelocity))) - (10 * Math.PI))) - poleRotation) / (1 + cartVelocity)
                    ;
