...
public class GPControlDemo {
    public static void main(String[] args) {
        ...
        final GPForceController controller = system -> {
            ...
            //double force = (cartPosition + (((Math.cos(Math.cos(poleAcceleration * (poleRotation * poleRotation))) - (Math.cos(cartPosition + poleVelocity) - Math.cos(Math.cos(((g * poleRotation) + ((cartDisplacement * (InvertedPendulumSystem.POLE_INERTIA + poleDisplacement)) - (poleVelocity + InvertedPendulumSystem.POLE_INERTIA))) - Math.cos(InvertedPendulumSystem.POLE_LENGTH))))) * Math.sin(Math.sin(Math.sin(cartPosition)))) - (poleRotation * g))) + (((((InvertedPendulumSystem.POLE_INERTIA * (cartAcceleration - (((poleRotation * InvertedPendulumSystem.POLE_MASS) - (cartPosition + poleVelocity)) - (cartPosition + poleVelocity)))) - poleRotation) - ((Math.sin(cartVelocity) * Math.cos(InvertedPendulumSystem.POLE_INERTIA)) + poleVelocity)) * Math.cos(Math.cos(Math.cos(Math.sin(Math.cos(((poleRotation * InvertedPendulumSystem.POLE_MASS) - (cartPosition + poleVelocity)) + g)) - (poleVelocity - poleDisplacement))))) - (poleRotation * g))
            double force = ((cartPosition + ((((((InvertedPendulumSystem.POLE_INERTIA - (Math.sin(poleRotation - cartPosition) - ((((InvertedPendulumSystem.POLE_MASS * InvertedPendulumSystem.POLE_INERTIA) * ((g * poleVelocity) + cartVelocity)) - ((poleRotation - cartPosition) + (g * poleVelocity))) - Math.sin((g * poleVelocity) - cartPosition)))) - ((((cartPosition + (poleVelocity / g)) - cartPosition) + (g * poleVelocity)) * (InvertedPendulumSystem.POLE_INERTIA - cartVelocity))) - Math.sin((InvertedPendulumSystem.POLE_INERTIA - cartVelocity) / ((((InvertedPendulumSystem.POLE_INERTIA * cartVelocity) * (poleVelocity * poleVelocity)) - cartPosition) + (g * poleVelocity)))) * InvertedPendulumSystem.POLE_INERTIA) - cartPosition) - (poleRotation - cartPosition))) - (cartPosition + (cartPosition + (poleVelocity / g)))) - (poleRotation - cartPosition)
                    ;
